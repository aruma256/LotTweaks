...
public class HudTextRenderer {
	...
	public static void showServerSideRequiredMessage(GuiGraphicsExtractor guiGraphics, String requiredVersion) {
		showServerSideRequiredMessage(guiGraphics, Minecraft.getInstance().getWindow(), requiredVersion);
	}

	public static void showServerSideRequiredMessage(GuiGraphicsExtractor guiGraphics, Window scaledResolution, String requiredVersion) {
	...
	public static void showMessage(GuiGraphicsExtractor guiGraphics, Window scaledResolution, String msg) {
		showMessage(guiGraphics, scaledResolution, msg, COLOR_DEFAULT);
	}

	private static void showMessage(GuiGraphicsExtractor guiGraphics, Window scaledResolution, String msg, int color) {
		...
		guiGraphics.text(mc.font, msg, x, y, ARGB.opaque(color));
	}
